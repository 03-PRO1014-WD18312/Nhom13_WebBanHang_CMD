                ...
                <div class="col-lg-3  col-sm-6">
                    <div class="service-wrapper free-shipping">
                        ...
                        <div class="service-content">
                            <h5 class="service-info service-title">Miễn phí ship</h5>
                            <p class="service-info service-details">Khi đặt hàng trên 1 TRIỆU</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="service-wrapper free-shipping">
                        ...
                        <div class="service-content">
                            <h5 class="service-info service-title">Đổi trả miễn phí</h5>
                            <p class="service-info service-details">Trong 30 ngày</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
                    <div class="service-wrapper free-shipping">
                        ...
                        <div class="service-content">
                            <h5 class="service-info service-title">Thanh toán an toàn</h5>
                            <p class="service-info service-details">Thanh toán trực tuyến an toàn 100%</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6">
            ...
            <div class="row gy-5">
                <div class="col-lg-3 col-sm-6">
                    <div class="footer-order">
                        <div class="logo">
                            <img src="assets/images/logos/footer.png" alt="logo">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="about-us">
                        ...
                        <div class="footer-link about-link">
                            <ul>
                                <li><a href="index.php?action=about">Liên hệ</a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="links">
                        ...
                        <div class="footer-link useful-link">
                            <ul>
                                <li><a href="index.php?action=about">Thanh toán an toàn</a></li>
                                <li><a href="#">Chính sách bảo mật</a></li>
                                <li><a href="#">Điều khoản sử dụng</a></li>
                                <li><a href="#">Sản phẩm đã lưu trữ</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="footer-link contact-link">
                            <div class="address">
                                ...
                                <div class="details">
                                    ...
                                    <p>Trịnh Văn Bô, Cầu Diễn, Hà Nội</p>
                                </div>
                            </div>
