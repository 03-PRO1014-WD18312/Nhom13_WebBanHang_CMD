                    ...
                    <div class="checkout-wrapper">
                        ...
                        <div class="account-section billing-section">
                            ...
                            <div class="review-form">
                                <form action="index.php?action=lichsumuahang" method="post">
                                    ...
                                    <input type="hidden" name="idsanphambienthe" value="<?= $id ?>" id="">
                                    <input type="hidden" name="soluongsanpham" value="<?= $quantity ?>" id="">
                                    <input type="submit" class="shop-btn" name="muangayhoantat" value="Đặt hàng" id="">
                                </form>
                        ...
                        <div class="account-section billing-section">
                            ...
                            <div class="order-summery">
                                    ...
                                    <ul class="product-list">
                                        <li>
                                            <div class="product-info">
                                                <h5 class="wrapper-heading"><?= $name ?> </h5>
                                                <p class="paragraph">Số lượng:<?= $quantity ?></p>
                                                <p class="paragraph"><?= $color ?></p>
                                            </div>
                                            <div class="price">
                                                <h5 class="wrapper-heading"><?= number_format((int)$quantity * (int)$price, 0, ",", ".") ?><sup>đ</sup></h5>
                                            </div>
                                        </li>
                                ...
                                <div class="subtotal total">
                                    <h5 class="wrapper-heading">TỔNG</h5>
                                    <h5 class="wrapper-heading price"><?= number_format((int)$quantity * (int)$price + (int)$phiship, 0, ",", ".") ?><sup>đ</sup></h5>
                                </div>
                            </div>
                        </div>
                    </div>
