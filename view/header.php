...
<head>
    ...
    <link rel="icon" href="assets/images/homepage-one/80411896.png">
    <title>Web bán hàng CMD</title>
                ...
                <div class="header-center">
                    ...
                    <div class="header-cart-items">
                        ...
                        <div class="header-cart">
                            <a href="index.php?action=listCart" class="cart-item">
                                <span>
                                ...
                                <span class="cart-text" id="totalProduct" style="color: #d63384;">
                        ...
                        <div class="header-user">
                            ...
                            if (isset($_SESSION['email'])) {
                                ($_SESSION['email']);
                            ?>
                                <a href="index.php?action=user-profile">
                                    <span>
                ...
                <div class="header-nav">
                    <div class="category-menu-section position-relative">
                        ...
                        <div class="category-dropdown position-absolute" id="subMenu">
                            <ul class="category-list">
                                <?php foreach ($danhsachdanhmuc as $danhmuc) :
                                    $linkdanhmuc = "index.php?action=sanpham&iddanhmuc=" . $danhmuc['iddanhmuc'];
                                ?>
                                    <li class="category-list-item">
                                        <a href="index.php?action=product-sidebar">
                                            <div class="dropdown-item">
                                                <div class="dropdown-list-item">
                                                    <span class="dropdown-text">
                                                        <a href="<?= $linkdanhmuc ?>"><?= $danhmuc['tendanhmuc'] ?></a>
                                                    </span>
                                                </div>
                                                <div class="drop-down-list-icon">
                                                    <span>
                    ...
                    <div class="header-nav-menu">
                        <ul class="menu-list">
                                ...
                                <div class="shop-menu">
                                    <div class="menu-wrapper">
                                        <div class="menu-list">
                                            ...
                                            <ul>
                                                <li><a href="index.php?action=product-sidebar">Shirt</a></li>
                                                <li><a href="index.php?action=product-sidebar">Skart</a></li>
                                                <li><a href="index.php?action=product-sidebar"> T-Shirt</a></li>
                                            </ul>
                                        </div>
                                        <div class="menu-list">
                                            <h5 class="menu-title">Bags</h5>
                                            <ul>
                                                <li><a href="index.php?action=product-sidebar">HandBags</a></li>
                                                <li><a href="index.php?action=product-sidebar">Mobile Bags</a></li>
                                                <li><a href="index.php?action=product-sidebar">School Bags</a></li>
                                            </ul>
                                        </div>
                                        <div class="menu-list">
                                            <h5 class="menu-title">Cosmetics</h5>
                                            <ul>
                                                <li><a href="index.php?action=product-sidebar">Liptics</a></li>
                                                <li><a href="index.php?action=product-sidebar">Foundation</a></li>
                                                <li><a href="index.php?action=product-sidebar"> Eye Liner</a></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <?php  }  ?>
                            <li>
                                <a href="index.php?action=contact-us">
