                ...
                <div class="sidebar" data-aos="fade-right">
                    <div class="sidebar-section">
                            ...
                            <div class="sidebar-item">
                                <ul class="sidebar-list">
                                    <?php foreach ($danhsachdanhmuc as $key => $danhmuc) {
                                        extract($danhmuc);
                                        $linkdanhmuc = "index.php?action=sanpham&iddanhmuc=" . $iddanhmuc;
                                        echo '
                        <li>
                            
                            <label for=""><a href="' . $linkdanhmuc . '">' . $tendanhmuc . '</a></label>
                        </li>';
                                    } ?>
                                </ul>
                            </div>
                        ...
                        <div class="sidebar-wrapper sidebar-range">
                            <h5 class="wrapper-heading">Phạm vi giá</h5>
                        ...
                        <hr>
                        <div class="sidebar-wrapper">
                            <h5 class="wrapper-heading">Màu</h5>
                            <div class="sidebar-item">
                                <ul class="sidebar-list">
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <label for="blue">Trắng</label>
                                    </li>
                                    <li>
                                        <input type="checkbox" id="navy" name="navy">
                                        <label for="navy">Xanh</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="row g-5">
                        <div class="col-lg-12">
                            <div class="product-sorting-section">
                                <div class="result">
                                    <p>Hiển thị <span>1–16 trên 66 kết quả</span></p>
                                </div>
                        ...
                        <?php foreach ($danhsachloaisanpham as $key => $sanpham) {
                            extract($sanpham);
                                ...
                                <div class="product-wrapper" data-aos="fade-up">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-description">
                                            ...
                                            <div class="price">
                                                <span class="price-cut"><?= $giasanpham ?></span>
                                                <span class="new-price"><?= $giasale ?></span>
                                            </div>
                                        </div>
                                    </div>
