                ...
                <div class="col-lg-6">
                    <div class="contact-info-section">
                        <div class="contact-information">
                            <h5 class="wrapper-heading">Thông tin liên lạc</h5>
                            <p class="paragraph">Điền vào mẫu dưới đây hoặc gửi mail cho chúng tôi. Chúng tôi sẽ hỗ trợ bạn.</p>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="wrapper phone">
                                            ...
                                            <div class="wrapper-content">
                                                <h5 class="wrapper-heading">Số điện thoại</h5>
                                                <p class="paragraph">123 456 789</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="wrapper phone">
                                            ...
                                            <div class="wrapper-content">
                                                ...
                                                <p class="paragraph"><a href="https://quomodothemes.website/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fda88e988fbd9a909c9491d39e9290">[email&#160;protected]</a></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="address">
                                            <div class="contact-address">
                                                ...
                                                <div class="address-content">
                                                    <h5 class="wrapper-heading">Địa chỉ</h5>
                                                    <p class="paragraph">Trịnh Văn Bô, Cầu Diễn, Hà Nội</p>
                                                </div>
                                            </div>
                                            <div class="contact-map">

                                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59587.9463811962!2d105.79576387341166!3d21.022814759496267!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ab9bd9861ca1%3A0xe7887f7b72ca17a9!2zSMOgIE7hu5lpLCBWaeG7h3QgTmFt!5e0!3m2!1svi!2s!4v1701232664764!5m2!1svi!2s" width="524" height="206" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6">
                    <div class="question-section login-section ">
                        <div class="review-form">
                            <h5 class="comment-title">Liên lạc</h5>
                            ...
                            <div class="review-textarea">
                                ...
                                <textarea class="form-control" placeholder="Viết mô tả..........." id="floatingTextarea" rows="3"></textarea>
                            </div>
                            <div class="login-btn">
                                <a href="#" class="shop-btn">Gửi</a>
                            </div>
                        </div>
                    </div>
                </div>
