...
<section class="admin-content">
    ...
    <div class="admin-content-right">
        <form action="index.php?action=updatesanpham.php" method="post" id="formbienthe" enctype="multipart/form-data">
                ...
                <div class="form-control">
                    <div class="cod-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="tenloaisanpham" id="product-name" class="cod-md-2" required value=<?= $tenloaisanpham ?>>
                        </div>
                        <div class="form-group">
                            <label for="description">Mô tả<span style="color: red;">*</span></label>
                            <textarea name="motasanpham" id="description" cols="30" rows="10" class="cod-md-2" required><?= $motasanpham ?></textarea>
                        </div>
                    </div>
                    <div class="cod-md-6">
                        <div class="form-group">
